...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Delete data from supplier table
    ...
    if (!empty($supplierID)) {
        ...
        $success_message = "Please provide a Supplier ID";
    }
}
...
<head>
    ...
    <title>Delete Supplier Data</title>
    <style>
        body {
...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
    ...
    <?php } ?>
    <input type="number" name="supplierID" placeholder="Supplier ID" value="<?php echo $supplierID; ?>" required><br>
